...
public class StrainerRecipeFluidTagBuilder implements RecipeBuilder {
    ...
    public StrainerRecipeFluidTagBuilder(TagKey<Item> ingredient, ItemLike result, int count, double outputChance, double chanceIncreasePerTier, int meshTier, int duration, String fluidAbove) {
