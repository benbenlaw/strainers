...
public class StrainerRecipe implements Recipe<SimpleContainer> {
    ...
    private final Ingredient inItem;
    private final Ingredient meshItem;
    ...
    public StrainerRecipe(ResourceLocation id, ItemStack output1, double outputChance1,
                          ...
                          Ingredient inItem, Ingredient meshItem, int duration, ItemStack blockAbove, String fluidAbove) {
    ...
    public boolean matches(@NotNull SimpleContainer pContainer, @NotNull Level pLevel) {
        ...
        ItemStack[] meshItems = meshItem.getItems();
        ItemStack[] inputItems = inItem.getItems();
    ...
    public static class Serializer implements RecipeSerializer<StrainerRecipe> {
        ...
        public StrainerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            JsonElement jsonelementInput = (GsonHelper.isArrayNode(json, "inItem") ? GsonHelper.getAsJsonArray(json, "inItem") : GsonHelper.getAsJsonObject(json, "inItem"));
            Ingredient inItem = Ingredient.fromJson(jsonelementInput);

            JsonElement jsonelementMesh = (GsonHelper.isArrayNode(json, "mesh") ? GsonHelper.getAsJsonArray(json, "mesh") : GsonHelper.getAsJsonObject(json, "mesh"));
            Ingredient meshItem = Ingredient.fromJson(jsonelementMesh);
            ...
            return new StrainerRecipe(id, output1, outputChance1, output2, outputChance2, output3, outputChance3,
                    output4, outputChance4, output5, outputChance5, output6, outputChance6, output7, outputChance7, output8, outputChance8, output9, outputChance9, inItem, meshItem, duration, blockAbove, fluidAbove);
        }
        ...
        public StrainerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            Ingredient inItem = Ingredient.fromNetwork(buf);
            Ingredient meshItem = Ingredient.fromNetwork(buf);
        ...
        public void toNetwork(FriendlyByteBuf buf, StrainerRecipe recipe) {
            ...
            recipe.getMeshItem().toNetwork(buf);
            recipe.getInItem().toNetwork(buf);
