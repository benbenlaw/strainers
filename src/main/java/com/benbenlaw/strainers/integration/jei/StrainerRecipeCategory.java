...
public class StrainerRecipeCategory implements IRecipeCategory<StrainerRecipe> {
    ...
    public RecipeType<StrainerRecipe> getRecipeType() {
        return new RecipeType<>(ModRecipes.STRAINERS_SERIALIZER.getId(), StrainerRecipe.class);
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, StrainerRecipe recipe, IFocusGroup focusGroup) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 44, 35).addIngredients(recipe.getMeshItem());
        builder.addSlot(RecipeIngredientRole.INPUT, 62, 35).addIngredients(recipe.getInItem());
     ...
     //           .setHoverName(Component.literal(recipe.getFluidAbove().getItem().getName(recipe.getBlockAbove().getItem().asItem()
      //          .getDefaultInstance()).getString() + ", Place Above The Strainer")));
    ...
    private IRecipeSlotTooltipCallback getChance1(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance1() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance2(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance2() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance3(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance3() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance4(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance4() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance5(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance5() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance6(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance6() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance7(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance7() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance8(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance8() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getChance9(StrainerRecipe recipe) {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Chance: " +  ((int) (recipe.getOutputChance9() * 100)) + "%"));
        };
    }
    private IRecipeSlotTooltipCallback getPlaceAbove() {
        return (chance, addTooltip) -> {
            addTooltip.add(Component.translatable("Place above the strainer"));
        };
    }
